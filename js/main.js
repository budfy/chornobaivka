function countTime() {
  const lastDate = document.querySelector('.timer').dateTime;
  ...
  function countUpFromTime(countFrom) {
    ...
    let str = '';
    str += years > 0 ? `<span class="timer__item"><b class="count">${years}</b>р. </span>` : ``;
    str += days > 0 ? `<span class="timer__item"><b class="count">${days}</b>д. </span>` : ``;
    str += hours > 0 ? `<span class="timer__item"><b class="count">${hours}</b>год.</span>` : ``;
    str += `<span class="timer__item"><b class="count">${mins}</b>хв.</span> <span class="timer__item"><b class="count">${secs}</b>сек.</span>`;
